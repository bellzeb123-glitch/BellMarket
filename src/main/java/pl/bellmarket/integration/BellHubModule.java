...
public final class BellHubModule implements BellModule {
    ...
    public List<ActionDef> actions() {
        return List.of(
                ...
                ActionDef.of("settings.purchasesEnabled", "Włącz/wyłącz zakupy", "Ustawienia",
                        ActionField.bool("value", "Zakupy włączone")),
                ...
                ActionDef.of("category.setEnabled", "Włącz/wyłącz sekcję", "Katalog",
                        ActionField.text("id", "ID kategorii"), ActionField.bool("value", "Włączona")),
                ActionDef.of("category.setAllPrices", "Ceny całej sekcji", "Katalog",
                        ActionField.text("id", "ID kategorii"),
                        ActionField.select("mode", "Tryb", List.of("set", "multiply", "add")),
                        ActionField.number("value", "Wartość (set=cena, multiply=% np. 110, add=delta)")),
                ...
                ActionDef.of("product.setPrices", "Zapisz wiele cen", "Katalog",
                        ActionField.text("category", "ID kategorii"),
                        ActionField.text("changes", "id:cena|id:cena|...")),
                ActionDef.of("product.exclude", "Ukryj/przywróć produkt w sklepie (provider)", "Katalog",
                        ActionField.text("category", "ID kategorii"), ActionField.text("id", "ID produktu"),
                        ActionField.bool("value", "Ukryj")),
